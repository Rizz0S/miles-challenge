...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"localStorage.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/redux-undo/lib/actions.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
},{"./actions":"node_modules/redux-undo/lib/actions.js","./helpers":"node_modules/redux-undo/lib/helpers.js","./reducer":"node_modules/redux-undo/lib/reducer.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
var persistedState = localStorage.getItem('boardState') ? (0, _localStorage.loadState)() : initHistory;
var store = (0, _redux.createStore)((0, _reduxUndo.default)(reducer), persistedState);
store.subscribe(function () {
  (0, _localStorage.persistState)(store.getState());
});
(0, _redux.combineReducers)({
  reducer: (0, _reduxUndo.default)(reducer)
});
var draggableTile = document.getElementById('drag-tile');
...
function dragElement(el) {
  ...
  function closeDrag(e) {
    ...
    if (dropTarget.className === "category") {
      var innerDropTarget = dropTarget.firstElementChild;
      var reward = innerDropTarget.classList[1];
      var category = innerDropTarget.classList[2];
      store.dispatch({
        type: "ADD_CATEGORY",
        payload: {
          reward: reward,
      ...
      document.querySelector(".remove-btn.".concat(reward, ".").concat(category)).style.opacity = "1";
      innerDropTarget.style.visibility = "visible";
      innerDropTarget.style.opacity = "1";
    }
...
function mapTilesToBoardState(i, j, tile, removeBtn, state) {
...
init();
},{"redux":"node_modules/redux/es/redux.js","./localStorage.js":"localStorage.js","redux-undo":"node_modules/redux-undo/lib/index.js"}],"../../.nvm/versions/node/v13.3.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../.nvm/versions/node/v13.3.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.js"], null)
